...
const swapFuncSelector = '0x7c025200000000000000000000000000';
const uniswapV4SwapFuncSelector = 'e449022e000000000000000000000000';
...
// Swagger API: https://docs.1inch.io/docs/aggregation-protocol/api/swagger
...
/// @returns Object: (functionSelector: function intended to be used by 1inch for swap. data: route data for swap on 1inch)
const getFormatedSwapData = (response, synthwapAddress) => {
	// tx calldata generated by 1inch
	const calldata = response.tx.data;

	// swapFuncSelector or uniswapV4SwapFuncSelector
	...
	if (funcSelector === uniswapV4SwapFuncSelector) {
		...
		// decontruct response
		abiDecoder.addABI(JSON.parse(AggregationRouterV4ABI));
		...
		throw 'Response contains invalid tx data';
	}
};
